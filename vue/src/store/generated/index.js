...
import HelloPlanetHelloPlanetPlanet from './hello/planet/hello.planet.planet';
...
export default {
    HelloPlanetHelloPlanetPlanet: load(HelloPlanetHelloPlanetPlanet, 'hello.planet.planet'),
